...
const CustomSelect = ({ label, parentContainer, container, className, value, options, placeholder, defaultValue, componentHandler, ...props }: CustomSelectProps) => {
  ...
  return (
    <div className={`w-full h-full rounded-[0.313rem] border-[0.022rem] border-asoebiGray-900 ${parentContainer}`}>
